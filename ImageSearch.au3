...
Func _FindImage($left, $top, $right, $bottom, $fileName, $tolorance)
   Local $answer[2] = [-1,-1]
   ...
   Local $result = DllCall("C:\Users\Kijja\AutoITProject\Summoner War\ImageSearchDLL.dll", "str", "ImageSearch", "int", $left, "int", $top, "int", $right, "int", $bottom, "str", $findImage)
